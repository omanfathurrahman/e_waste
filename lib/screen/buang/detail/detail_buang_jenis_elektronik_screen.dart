...
class DetailBuangJenisElektronikScreen extends StatefulWidget {
  ...
  const DetailBuangJenisElektronikScreen({
    super.key,
  ...
  @override
  State<DetailBuangJenisElektronikScreen> createState() =>
      _DetailBuangJenisElektronikScreenState();
}
...
class _DetailBuangJenisElektronikScreenState
  ...
  Future<void> tambahKeKeranjang() async {
    if (pilihanKategori == "") {
      await Supabase.instance.client.from("keranjang_buang").insert({
            ...
            child: ListView(
              children: switch (widget.jenisKategorisasi) {
                "none" => <Widget>[
                    ...
                    KomponenJumlahBarang(
                      gantiJumlah: gantiJumlah,
                    ),
                    const SizedBox(height: 16),
