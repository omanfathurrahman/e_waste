...
import 'package:ewaste/screen/buang/daftar_droppoin/daftar_droppoin.dart';
import 'package:flutter/material.dart';

class BawaKeDropPointBuangScreen extends StatefulWidget {
  const BawaKeDropPointBuangScreen({super.key});

  @override
  State<BawaKeDropPointBuangScreen> createState() =>
      _BawaKeDropPointBuangScreenState();
}

enum PilihanAlamat { alamatSaatIni, aturUlang }

class _BawaKeDropPointBuangScreenState
    extends State<BawaKeDropPointBuangScreen> {
                    ...
                    MaterialPageRoute(
                      builder: (context) => FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return DaftarDroppoinBuang(alamatId: alamatId);
                          }),
                    ),
                  ),
                },
