...
class _KeranjangDonasiState extends State<KeranjangDonasi> {
  ...
  Future<void> _donasiSampahDiKeranjang({required num beratKeseluruhan}) async {
    if (beratKeseluruhan < 100) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Silahkan masukkan alamat anda")));
        ...
        await supabase.from('detail_sampah_didonasikan').insert([
          {
            ...
            "id_sampah_dibuang": idSampahDidonasikanBaru['id'],
          }
        ]);
      }
      await supabase
