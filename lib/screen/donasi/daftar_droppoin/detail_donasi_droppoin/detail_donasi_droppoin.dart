...
class DetailDonasiDroppoin extends StatefulWidget {
  const DetailDonasiDroppoin({super.key, required this.droppoinId});
  final num droppoinId;

  @override
  State<DetailDonasiDroppoin> createState() => _DetailDonasiDroppoinState();
}

class _DetailDonasiDroppoinState extends State<DetailDonasiDroppoin> {
  @override
  initState() {
    _getDroppoinData();
    _getDroppoinMap();
